...
export const SERVICES = [
  {
    ...
    faqs: [
      ...
      { q: 'My compactor came from a hauler. Can you work on it?', a: 'If the hauler owns the machine, service is contractually theirs. If you own or rent it from anyone else, we can work on it. Not sure? We can help you read the contract, and show you what owning your own equipment saves.' },
