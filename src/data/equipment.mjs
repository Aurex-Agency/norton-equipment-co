...
export const COMPACTORS = [
  ...
  },
  {
    ...
    features: [
      ...
      { h: 'Trade-ins welcome', p: 'Upgrading? We buy and trade compactors and balers, which feeds the reconditioning program.' },
    ],
    faqs: [
...
export const BALER_OVERVIEW = {
  ...
  types: [
    ...
    { slug: 'specialty-balers', blurb: 'Foam, film, and other specialty materials, built to order.' },
...
export const BALERS = [
  ...
  },
  {
    ...
    features: [
      { h: 'Two rams, no waiting', p: 'A dedicated compression ram and eject ram let the machine keep taking material while it clears finished bales.' },
      { h: 'Multi-material by design', p: 'OCC, plastics, film, and mixed commodities: two-ram balers switch materials without a rebuild.' },
  ...
  },
  {
    ...
    kicker: 'Foam, Film & More · Built to Order',
    short: 'Balers built for foam, film, and other specialty materials, ordered to spec.',
    metaTitle: 'Specialty Balers | Foam, Film & Hard-to-Bale Materials | Norton Equipment',
    metaDesc:
      'Specialty balers for foam, film, and other hard-to-bale materials across the Mid-South. Built to order and serviced by Norton Equipment, independent since 1997.',
    intro: [
      ...
      'Norton sources and builds specialty balers to order for the materials you actually handle. Tell us what you are baling and the volume, and we will spec the right machine, install it, and keep it running with our own service techs.',
    ],
    ...
    features: [
      ...
      { h: 'Built to order', p: 'Specialty balers are ordered and configured to your material and volume rather than stocked.' },
    ...
    faqs: [
      ...
      { q: 'Are specialty balers in stock?', a: 'They are built to order to fit your specific material and volume. Send us a sample or a description and we will spec the machine.' },
